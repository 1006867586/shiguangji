  ...
  return (
    <main style={pageStyle}>
      <article style={articleStyle}>
        ...
        <p>
          欢迎使用 <strong>{APP_NAME}</strong>（以下简称"本服务"）。在使用本服务之前，
          请您仔细阅读本《用户服务协议》（以下简称"本协议"）。一旦您开始使用本服务，即视为您已充分理解、
          同意并接受本协议全部条款。
        </p>
        ...
        <ol>
          <li>
            您在本服务发布的文字、图片、评论等内容（以下统称"用户内容"）的知识产权归您或原始权利人所有；
          </li>
          <li>
        ...
        <ul>
          <li>
            本服务按"现状"提供，运营者不对服务的及时性、安全性、稳定性、准确性作出任何明示或暗示的承诺；
          </li>
          <li>
