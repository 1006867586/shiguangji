  ...
  return (
    <main style={pageStyle}>
      <article style={articleStyle}>
        ...
        <p>
          {APP_NAME} 是一款面向小团体的聚餐工具类微信小程序，提供美食转盘随机选餐、店铺收藏与图片识别导入、
          个人资料管理等功能。本服务<strong>不提供</strong>用户内容发布、评论、转发、群组聊天、消息通知或朋友圈类功能，
          旨在为用户提供一个管理聚餐店铺与决策&ldquo;今天吃什么&rdquo;的工具。
        </p>
        ...
        <ul>
          <li>利用本服务发布、传播违反国家法律法规、危害国家安全、宣扬恐怖主义、民族仇恨、色情、暴力等内容；</li>
        ...
        <ol>
          <li>
            本服务不提供公开发布内容的渠道，您填写的昵称、头像、收藏的店铺信息仅保存在您自己的账户下，
            不会被其他用户查看；
          </li>
          <li>
            您在收藏录入的店铺信息（店名、地址、电话、招牌菜等）的知识产权归您或原始权利人所有；
          </li>
          <li>
            您录入的内容应合法合规，如因您的内容导致第三方投诉或法律责任，由您自行承担；
          </li>
          <li>
