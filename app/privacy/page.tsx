 ...
 * - 政策变更与生效日期
 *
 * 当前为个人主体工具类小程序，仅提供：微信登录、昵称头像、转盘选餐、店铺收藏。
 */
  ...
  return (
    <main style={pageStyle}>
      <article style={articleStyle}>
        ...
        <p>本服务是一款个人使用的本地化工具类微信小程序，旨在帮助您解决&ldquo;今天吃什么&rdquo;的日常选择问题，
          目前提供以下功能：</p>
        <ul>
          <li><strong>微信一键登录</strong>：用于识别您的身份，便于在多设备同步您的数据；</li>
          <li><strong>个人资料管理</strong>：您可填写昵称、选择头像，仅用于本账户识别；</li>
          <li><strong>美食转盘</strong>：根据您预先设定的候选清单随机选出今日用餐方向；</li>
          <li><strong>店铺收藏</strong>：手动录入或通过图片识别导入您感兴趣的店铺信息。</li>
        </ul>
        <p>
        ...
        <ol>
          ...
          <li>
            ...
            该分享码不包含您的个人身份信息，仅用于扫码加载对应的候选清单（被分享者无需注册账号）。
          </li>
          <li>
